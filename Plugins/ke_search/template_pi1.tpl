...
<div class="pages_total">
	<p>###RESULTS### ###START### ###UNTIL### ###END### ###OF### ###TOTAL###</p>
	<p>###PREVIOUS### ###PAGES_LIST### ###NEXT###</p>
</div>
